...
end_num = start_num + 1
dataset_root = "./B"
root_path_weight = f"./style_8_15_text_14_65_addce_ip_text_14_001_700_2"
seed_train = 1723819627
...
with torch.no_grad():
    for taskid in tqdm.tqdm(range(start_num, end_num)):
        ...
        pipe.load_lora_weights(f"{root_path_weight}/style_{taskid:02d}_{seed_train}/pytorch_lora_weights.bin")
        ...
        for id, prompt in prompts.items():
            ...
            os.makedirs(f"{args.output_dir}/{taskid:02d}_{seed_train}_70", exist_ok=True)
            image.save(f"{args.output_dir}/{taskid:02d}_{seed_train}_70/{prompt}.png")